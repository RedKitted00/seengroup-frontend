      ...
      <Container size="xl" py="xl">
        <Group justify="space-between" mb="md" wrap="wrap" gap="xs">
          ...
          <Group gap="xs" wrap="wrap">
            ...
            />
            <TextInput
              placeholder="Search by name, description, OEM number, or manufacturer..."
              value={searchTerm}
              onChange={(e) => handleSearchChange(e.currentTarget.value)}
              leftSection={<IconSearch size={16} />}
              w={{ base: "100%", xs: 300 }}
              aria-label="Search products by name, description, OEM number, or manufacturer"
              description="Search across product names, descriptions, OEM numbers, and manufacturers"
            />
            <Button
